...
mallet train-topics --input $fpath/cleanbills-20170814.mallet --num-topics $1 --optimize-interval 10 --output-state $fpath/topic_state_$1.gz --output-topic-keys $fpath/keys_$1.txt --output-doc-topics $fpath/composition_$1.txt  --random-seed 999 --topic-word-weights-file $fpath/topic-word-weights_$1 --diagnostics-file $fpath/diagnostics.xml